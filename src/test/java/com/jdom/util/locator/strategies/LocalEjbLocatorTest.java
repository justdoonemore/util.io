...
public class LocalEjbLocatorTest {
    private final LocalEjbLocator locator = new LocalEjbLocator();

    private static final TestSamePackageImplService serviceImpl = new TestSamePackageImpl();

    @BeforeClass
    public static void beforeClass() {
        MockContext.registerInJndi(TestSamePackageImplService.class.getName() + LocalEjbLocator.LOCAL_SUFFIX,
                serviceImpl);
    }
    ...
    @Test
    public void testLookingUpLocalEjb() throws NamingException {
