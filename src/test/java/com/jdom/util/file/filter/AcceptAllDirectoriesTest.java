...
public class AcceptAllDirectoriesTest extends
		AbstractFilterTest<AcceptAllDirectories> {

	@Override
	protected AcceptAllDirectories getFilter() {
		return new AcceptAllDirectories();
	}
